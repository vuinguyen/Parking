...
/**
 The base class for all Parking modules
 */
...
/**
 Parking Platform calls this method on startup.
 */
-(void)startup;

/**
 Parking Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Parking Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Parking Platform calls this method on resume.
 @param sender The sender of the event.
 */
