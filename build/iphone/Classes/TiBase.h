...
// in simulator we redefine to format for Parking Developer console
...
{\
	NSString * exceptionName = [@"org.parking." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.parking";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIParkingNativeItemNone = -1, 
	UIParkingNativeItemSpinner = -2,
	UIParkingNativeItemProgressBar = -3,
	
	UIParkingNativeItemSlider = -4,
	UIParkingNativeItemSwitch = -5,
	UIParkingNativeItemMultiButton = -6,
	UIParkingNativeItemSegmented = -7,
	
	UIParkingNativeItemTextView = -8,
	UIParkingNativeItemTextField = -9,
	UIParkingNativeItemSearchBar = -10,
	
	UIParkingNativeItemPicker = -11,
	UIParkingNativeItemDatePicker = -12,
	
	UIParkingNativeItemInfoLight = -13,
	UIParkingNativeItemInfoDark = -14,
	
	UIParkingNativeItemDisclosure = -15,
	
	UIParkingNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Parking instances of
