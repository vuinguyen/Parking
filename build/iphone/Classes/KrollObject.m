 ...
 * Copyright (c) 2009-2011 by Parking, Inc. All Rights Reserved.
...
@interface ParkingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ParkingObject class]])
		{
			for (NSString *key in [[(ParkingObject*)o modules] allKeys])
			{
